...
<h1 className="text-[1.3rem] md:text-5xl font-bold mb-5 md:mb-20" data-aos="fade-up" data-aos-delay="50">
  ChainCred<span className="text-blue-500" data-aos="fade-up" data-aos-delay="70">.</span> Invests, Incubates, and <br /><span className='text-gray-300'>Accelerates Networks Securely</span> <br /> <span className='text-gray-400'>The Future of Open Source Due-Diligence on Stellar.</span>
</h1>
